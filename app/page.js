...
export const metadata = {
  title: 'Areeb Rehman | Full Stack AI Developer',
  description:
    'Full stack AI developer in Karachi building production web apps with React, Next.js and FastAPI, plus voice agents, automations and fine tuned models.',
  icons: {
