...
export const metadata = {
  title: 'Services | Areeb Rehman',
  description:
    'AI integrated web apps, voice agents and automation, model fine tuning, and deployment. Freelance full stack AI development from Karachi.',
  icons: {
